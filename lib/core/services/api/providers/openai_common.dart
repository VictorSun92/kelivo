    ...
    try {
      ...
      if (config.useResponseApi == true) {
        ...
        try {
          ...
          if (u != null) {
            final prompt =
                ((u['prompt_tokens'] ?? u['input_tokens']) as int?) ?? 0;
            final completion =
      ...
      while (true) {
        ...
        try {
          ...
          if (u is Map) {
            final prompt = (u['prompt_tokens'] as int?) ?? 0;
            final completion = (u['completion_tokens'] as int?) ?? 0;
            final cached =
                (u['prompt_tokens_details']?['cached_tokens'] ?? 0) as int? ??
                0;
      ...
      try {
        ...
        if (config.useResponseApi == true) {
          ...
          if (type == 'response.output_text.delta') {
            ...
            if (u != null) {
              final inTok = (u['input_tokens'] as int?) ?? 0;
              final outTok = (u['output_tokens'] as int?) ?? 0;
                  ...
                  for (int j = 0; j < lines2.length - 1; j++) {
                    ...
                    try {
                      ...
                      if (o is Map &&
                        ...
                        final item = o['item'];
                        final idx2 = (o['output_index'] as int?) ?? 0;
                        if (item is Map &&
                        ...
                        if (u2 != null) {
                          final inTok = (u2['input_tokens'] as int?) ?? 0;
                          final outTok = (u2['output_tokens'] as int?) ?? 0;
                          usage = (usage ?? const TokenUsage()).merge(
                            TokenUsage(
                              promptTokens: inTok,
